...
void CGameContext::OnClientEnter(int ClientID)
{
	...
	if(((CServer *) Server())->m_aPrevStates[ClientID] < CServer::CClient::STATE_INGAME)
	{
		...
		SendChatTarget(ClientID, "   BHCDDrace "  BHC_VERSION " by Black Hell Clan");
		SendChatTarget(ClientID, "   DDRace-mod with more extras ;)");
		SendChatTarget(ClientID, "   Based on the XXL Mod by XXLTomate");
